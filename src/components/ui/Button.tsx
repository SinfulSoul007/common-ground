...
const variantStyles: Record<string, string> = {
  primary:
    'bg-teal-700 text-white hover:bg-teal-800 focus:ring-teal-500 disabled:bg-teal-400',
  secondary:
    'bg-white text-slate-700 border border-slate-300 hover:bg-slate-50 focus:ring-slate-400 disabled:bg-slate-100 disabled:text-slate-400',
  danger:
